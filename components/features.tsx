...
import { Clock, DollarSign, Download, Phone, Wallet } from "lucide-react";
  ...
  const features = [
    {
      ...
      title: "Keine Kosten",
      description:
        "Weder die App-Nutzung noch die Ausbildung zum Sachverständigen kosten dich etwas – der Einstieg ist komplett risikofrei",
    },
    {
      icon: DollarSign,
      title: "Aufwandsentschädigung",
      description:
        "Mit Crashify profitieren Sie von einer fairen Vergütung für jedes erstellte Gutachten – eine lohnende Anerkennung Ihrer Expertise.",
    },
    {
      icon: Clock,
      title: "Zeitersparnis",
      description:
        "Unsere App ermöglicht eine effiziente Schadensaufnahme, sodass Sie mehr Zeit für Ihre Kunden haben und Ihre Arbeitsabläufe optimieren können.",
    },
  ];
      ...
      <div className="container mx-auto">
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <p className="text-base sm:text-lg text-muted-foreground">
            Entdecken Sie, wie Crashify Ihre Arbeit revolutioniert und
            optimiert.
          </p>
        </div>
