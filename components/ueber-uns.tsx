      ...
      <div className="container mx-auto">
        <div className="flex flex-col lg:flex-row gap-8 items-center">
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-between space-y-4">
            ...
            >
              Über Crashify: Revolutionäre Kfz-Schadensbewertung
            </h2>
            <p className="text-base sm:text-lg font-semibold text-gray-700">
              Gegründet 2020 von Max Maurer, Kfz-Meister und Betriebswirt,
              revolutioniert Crashify die digitale Schadensregulierung in
              Deutschland.
            </p>
