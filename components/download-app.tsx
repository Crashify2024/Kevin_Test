        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          <div className="lg:w-1/2">
            <h2 className="text-xl sm:text-2xl font-bold mb-4 text-white">
              Jetzt durchstarten mit Crashify
            </h2>
            <p className="text-base sm:text-lg mb-6 text-white/80">
              Crashify ist die innovative Enterprise-Grade-App für Mobilgeräte,
              die effiziente Schadensabwicklung auf ein neues Level bringt.
              Profitieren Sie von einer benutzerfreundlichen Lösung, die Zeit
              spart, Ihre Arbeit erleichtert und Ihnen neue
          ...
          <div className="lg:w-1/2 flex justify-center items-center">
            <div className="relative w-[200px] sm:w-[230px] md:w-[275px]">
              <Image
                src="/assets/crashify-hand-mobile-app.png"
