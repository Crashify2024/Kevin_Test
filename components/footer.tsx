      ...
      <div className="container mx-auto py-12 px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-sm">
              Innovative Schadensabwicklung für die moderne Automobilbranche.
              Wir revolutionieren die Unfallabwicklung.
            </p>
          </div>
          <div>
        ...
        <div className="border-t border-gray-200 mt-8 pt-8 text-sm text-center">
          <p>
            &copy; {new Date().getFullYear()} Crashify. Alle Rechte vorbehalten.
          </p>
        </div>
      </div>
    </footer>
