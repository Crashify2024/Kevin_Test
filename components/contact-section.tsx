      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Entdecken Sie, wie Crashify Ihre Schadensabwicklung revolutionieren
            kann. Kontaktieren Sie uns noch heute für eine maßgeschneiderte
            Lösung.
          </p>
        </div>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Unser Team bietet fundiertes Wissen aus der
                      Schadensabwicklung und hat bereits mehrere Tausend
                      Gutachten auf höchstem Qualitätsniveau erstellt.
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Egal ob Reparaturbetrieb oder wenn du als Gutachter
                      durchstarten möchtest, wir sind flexibel und finden
